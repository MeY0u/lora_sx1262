...
void setup_DW1000RSTnIRQ(int enable)
{
    ...
    else
    {
        ...
        HAL_GPIO_Init(SKU_RESET_GPIO_Port, &GPIO_InitStruct);
        HAL_GPIO_WritePin(SKU_RESET_GPIO_Port, SKU_RESET_Pin, GPIO_PIN_SET);
    }
}
...
{
	HAL_GPIO_WritePin(SKU_WAKEUP_GPIO_Port, SKU_WAKEUP_Pin, GPIO_PIN_RESET);
    Sleep(1);
    HAL_GPIO_WritePin(SKU_WAKEUP_GPIO_Port, SKU_WAKEUP_Pin, GPIO_PIN_SET);
